...
try{
 ...
 const battle=new Battle(challenger.machine,defender.machine,j.arena,j.seed,{mode:'auto',swapSpawns:j.swapSpawns,objective:j.objective||defender.objective||challenger.objective||'reactor'});

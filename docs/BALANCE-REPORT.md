# Balance report — Agent season 02
...
**107 tests** cover physics, replay, custom/unlimited construction, arbitrary fee/reward ratios, no expiry, null/zero personal caps, bookmarks, guest APIs, official priority, malformed inputs, account/agent authorization, concurrent accounting, refunds and recovery. The external CLI integration test runs a real child process and verifies one climate attempt despite a repeated submission.

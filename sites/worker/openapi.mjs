...
export const mainnetOpenApi = {
  ...
  components: {
    ...
    schemas: {
      ...
      Rules: { type: "object", additionalProperties: true, properties: { mode: { type: "string" }, combat: { const: "auto" }, versions: { type: "object" }, parts: { type: "array", items: { type: "object" } }, arenas: { type: "array", items: { type: "object" } } } },
      ...
      Bounty: { type: "object", additionalProperties: true, required: ["id", "status"], properties: { id: { type: "string", format: "uuid" }, status: { type: "string" }, entry: { type: ["string", "number"] }, reward: { type: ["string", "number"] }, scout: { type: "object" }, blueprint: { type: ["object", "null"] } } },
      Attempt: attempt,
  ...
  paths: {
    ...
    "/health": { get: operation({ operationId: "getHealth", summary: "Read truthful payment and settlement readiness.", result: { type: "object", additionalProperties: true } }) },
    ...
    "/me/bookmarks": { get: operation({ operationId: "listBookmarks", summary: "List private bounty bookmarks.", auth: true, result: { type: "array", items: ref("Bounty") } }) },
